...
entradas_temp[2]= (lectura_tempF/sensibilidadT)-273; //Dividimos entre la sensibilidad y ajustamos a grados centigrados
valor_tempC= (lectura_tempC/sensibilidadT)-273;
