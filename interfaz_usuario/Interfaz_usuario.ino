...
/////////////////////////////////////////////////////////////////////////¿ACTUALIZAR CON TEMPERATURA EN LOOP?//////////////////////
    ...
    lv_chart_set_next_value(chart, ser1, entradas_temp[2]);
     /*Set the next points on 'ser2'*/
    lv_chart_set_next_value(chart, ser2, entradas_corriente[2]);

    /*Directly set points on 'ser2'*/  //(borrar)
   /* ser2->y_points[0] = 80;
    ser2->y_points[1] = 70;
